      ...
      <div className="relative z-10 w-full max-w-4xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
          ...
          <div className="md:col-span-2 bg-white/70 dark:bg-zinc-900/70 border border-zinc-200/50 dark:border-zinc-800/50 rounded-bento-card p-6 sm:p-8 flex flex-col justify-between shadow-lg shadow-zinc-900/5 dark:shadow-black/20">
            ...
            <div className="mt-8 pt-4 border-t border-zinc-200/40 dark:border-zinc-800/50 flex flex-col sm:flex-row justify-between items-center gap-2">
              <span className="text-[11px] text-zinc-400 dark:text-zinc-500">
                © {new Date().getFullYear()} SUNAT. Área de Sistemas e Infraestructura.
              </span>
          ...
          <div className="flex flex-col gap-5">
            ...
            {/* Tile 2: Admin Badge Card (Dusty Blue Background) */}
            <div className="bg-bento-secondary dark:bg-zinc-900 border border-zinc-900/5 dark:border-zinc-800 rounded-bento-card p-6 flex flex-col justify-between shadow-md h-full min-h-[160px] text-zinc-950 dark:text-zinc-50">
              <div className="w-10 h-10 rounded-bento-control bg-zinc-950 text-white flex items-center justify-center shadow-sm">
              ...
              <div>
                ...
                <p className="text-xs text-zinc-900/80 dark:text-zinc-300 leading-relaxed font-semibold">
                  Módulo de control de cuentas de contribuyentes, accesos y bitácoras fiscales.
                </p>
              </div>
            </div>

            {/* Tile 3: Console Security Info (Peach Background) */}
            <div className="bg-bento-primary dark:bg-zinc-900 border border-zinc-900/5 dark:border-zinc-800 rounded-bento-card p-6 flex flex-col justify-between shadow-md h-full min-h-[140px] text-zinc-900 dark:text-zinc-50">
              <span className="text-[10px] font-black uppercase tracking-wider text-zinc-900/70 dark:text-zinc-400">
                Seguridad Interna
              </span>
              <div>
                ...
                <p className="text-xs text-zinc-800 dark:text-zinc-300 leading-relaxed font-medium">
                  Toda acción realizada en este módulo es registrada con IP, hora y usuario en los logs de seguridad.
                </p>
              </div>
            </div>
          ...
          {/* Tile 4: Server Status Information (Spans 2 columns) */}
          <div className="md:col-span-2 bg-white/40 dark:bg-zinc-900/40 border border-zinc-200/50 dark:border-zinc-800/50 rounded-bento-card p-5 flex items-start gap-4 shadow-sm">
            ...
            <div>
              <h4 className="text-sm font-bold text-zinc-900 dark:text-zinc-50">
                Infraestructura y Conexiones Activas
              </h4>
              <p className="text-xs text-zinc-500 dark:text-zinc-400 mt-1 leading-relaxed">
                El servidor está conectado a la base de datos central de planillas y al T-Registro para procesar consultas de usuarios con un tiempo estimado de respuesta inferior a 50ms.
              </p>
            </div>
          </div>

          {/* Tile 5: User Management quick notice (1 Column) */}
          <div className="bg-white/40 dark:bg-zinc-900/40 border border-zinc-200/50 dark:border-zinc-800/50 rounded-bento-card p-5 flex items-center gap-3.5 shadow-sm">
            <div className="p-3 bg-zinc-950 dark:bg-zinc-800 rounded-bento-control text-white dark:text-zinc-200 shrink-0">
            ...
            <div>
              ...
              <p className="text-xs text-zinc-500 dark:text-zinc-400 mt-0.5 leading-tight">
                Consulte, edite y revoque cuentas de contribuyentes.
              </p>
            </div>
          </div>
